...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* sagiso features */
        {"sagiso", "listmasternodes", &listmasternodes, true },
        {"sagiso", "getmasternodecount", &getmasternodecount, true },
        {"sagiso", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"sagiso", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"sagiso", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"sagiso", "masternodecurrent", &masternodecurrent, true },
        {"sagiso", "startmasternode", &startmasternode, true },
        {"sagiso", "createmasternodekey", &createmasternodekey, true },
        {"sagiso", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"sagiso", "listmasternodeconf", &listmasternodeconf, true },
        {"sagiso", "getmasternodestatus", &getmasternodestatus, true },
        {"sagiso", "getmasternodewinners", &getmasternodewinners, true },
        {"sagiso", "getmasternodescores", &getmasternodescores, true },
        {"sagiso", "mnsync", &mnsync, true },
        {"sagiso", "spork", &spork, true },
...
{
    return "> sagiso-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5600/\n";
}
