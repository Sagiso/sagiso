...
/** Utility functions used by the sagiso Qt UI.
 */
namespace GUIUtil
{
...
// Render sagiso addresses in monospace font
...
// Parse "sagiso:" URI into recipient object, return true on successful parsing
