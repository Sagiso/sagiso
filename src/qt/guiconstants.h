...
/* sagiso GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "sagiso"
#define QAPP_ORG_DOMAIN "sagiso.org"
#define QAPP_APP_NAME_DEFAULT "sagiso-Qt"
#define QAPP_APP_NAME_TESTNET "sagiso-Qt-testnet"
