...
#define PACKAGE_BUGREPORT "https://github.com/Sagiso/sagiso"

/* Define to the full name of this package. */
#define PACKAGE_NAME "sagiso Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sagiso Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sagiso"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sagiso.net/"
