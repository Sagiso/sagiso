...
const char * const PIVX_CONF_FILENAME = "sagiso.conf";
const char * const PIVX_PID_FILENAME = "sagiso.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";
const char * const PIVX_ACTIVE_MASTERNODE_CONF_FILENAME = "activemasternode.conf";


// sagiso only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\sagiso
// Windows >= Vista: C:\Users\Username\AppData\Roaming\sagiso
// Mac: ~/Library/Application Support/sagiso
// Unix: ~/.sagiso
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "sagiso";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty sagiso.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=5600\naddnode=seed1.sagiso.net:5599\naddnode=seed2.sagiso.net:5599\naddnode=seed3.sagiso.net:5599\naddnode=seed4.sagiso.net:5599\naddnode=seed5.sagiso.net:5599\naddnode=seed6.sagiso.net:5599\naddnode=seed7.sagiso.net:5599\naddnode=seed8.sagiso.net:5599\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override sagiso.conf
