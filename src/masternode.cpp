...
{
    if (nHeight >  3000000) return    60000 * COIN;
    if (nHeight >  1300000) return    50000 * COIN;
    if (nHeight >   800000) return    40000 * COIN;
    if (nHeight >   700000) return    35000 * COIN;
    if (nHeight >   500000) return    25000 * COIN;
    if (nHeight >   400000) return    20000 * COIN;
    if (nHeight >   350000) return    18000 * COIN;
    if (nHeight >   300000) return    14000 * COIN;
    if (nHeight >   250000) return    10000 * COIN;
    if (nHeight >   200000) return     7500 * COIN;
    if (nHeight >   150000) return     5000 * COIN;
    if (nHeight >    80000) return     4000 * COIN;
    if (nHeight >     1500) return     2000 * COIN;
...
{
    if (nHeight >   3000000) return        1 * COIN;
    if (nHeight >   1300000) return        2 * COIN;
    if (nHeight >    800000) return        3 * COIN;
    if (nHeight >    700000) return        4 * COIN;
    if (nHeight >    500000) return        6 * COIN;
    if (nHeight >    400000) return        7 * COIN;
    if (nHeight >    350000) return        8 * COIN;
    if (nHeight >    300000) return       10 * COIN;
    if (nHeight >    250000) return        8 * COIN;
    if (nHeight >    200000) return        6 * COIN;
    if (nHeight >    150000) return        5 * COIN;
    if (nHeight >     80000) return        3 * COIN;
    if (nHeight >      2500) return        2 * COIN;
    if (nHeight >       200) return        1 * COIN;
    if (nHeight >         2) return        1 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 sagiso tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 sagiso tx -> 1 confirmation
