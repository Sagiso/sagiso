...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("sagiso sagiso-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sagiso-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sagiso transaction") + "\n" +
                               "  sagiso-tx [options] -create [commands]   " + _("Create hex-encoded sagiso transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sagiso transaction
