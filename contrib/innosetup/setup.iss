...
#define MyAppName "sagiso Core"
#define MyAppPublisher "2021-2022 The sagiso Developers"
#define MyAppURL "https://github.com/Sagiso/sagiso"
#define MyAppExeName "sagiso-qt.exe"
#define MyAppExtraData "https://github.com/Sagiso/sagiso/releases/download/v2.0/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=sagisoSetup
...
[Files]
Source: ".\package\sagiso-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\sagiso\sagiso-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\sagiso\sagiso-Qt,strDataDir|{userappdata}\sagiso\}');
  Result := True;
end;
