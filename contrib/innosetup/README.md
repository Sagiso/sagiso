...
* Fill in the following data:
    * Application Name: `sagiso Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The sagiso Developers`
    * Application Website: `https://sagiso.net/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `sagiso`
* Add application files:
    * Select the file `sagiso-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `sagiso-2.0.0-win64-setup.exe`
