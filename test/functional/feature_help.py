...
"""Verify that starting sagiso with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sagiso with -? for help text")
        ...
        self.log.info("Start sagiso with -version for version information")
