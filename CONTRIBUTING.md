Contributing to sagiso Core
============================

The sagiso Core project operates an open contributor model where anyone is
...
The following applies to code changes to the sagiso Core project, and is not to be
confused with overall sagiso Network Protocol consensus changes.

Whether a pull request is merged into sagiso Core rests with the project merge
...
Patches that change sagiso consensus rules are considerably more involved than
...
Where a patchset proposes to change the sagiso consensus, it must have been
...
The project leader is the release manager for each sagiso Core release.
